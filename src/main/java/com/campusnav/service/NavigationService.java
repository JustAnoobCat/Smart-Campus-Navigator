...
public class NavigationService {
    ...
    public NavigationService() {
        ...
        addEdge("CR-303", "Stairs9");
        addEdge("Stairs9", "Stairs10");
        addEdge("Stairs10", "CR-304");
        ...
        addEdge("Male Lift-2", "c6");
        addEdge("c6", "Lab-3");
        addEdge("Lab-3", "Faculty Room-2");
        addEdge("Faculty Room-2", "Male WC-2");
        ...
        graph.addNode(new Location("Downstairs5", "Downstairs5 (200,155)", 3));
        graph.addNode(new Location("Downstairs6", "Downstairs6 (920,155)", 3));
        graph.addNode(new Location("Upstairs5", "Upstairs5 (235,190)", 3));
        graph.addNode(new Location("Upstairs6", "Upstairs6 (880,190)", 3));
        graph.addNode(new Location("Lt-401", "Lt-401 (265,200)", 3));
        graph.addNode(new Location("CR-403", "CR-403 (445,200)", 3));
        graph.addNode(new Location("c11", "c11 (525,200)", 3));
        graph.addNode(new Location("CR-406", "CR-406 (675,200)", 3));
        graph.addNode(new Location("c12", "c12 (595,200)", 3));
        graph.addNode(new Location("Lt-402", "Lt-402 (855,200)", 3));
        graph.addNode(new Location("Staff Room-5", "Staff Room-5 (525,380)", 3));
        graph.addNode(new Location("Staff Room-6", "Staff Room-6 (595,380)", 3));
        graph.addNode(new Location("Stairs13", "Stairs13 (560,410)", 3));
        ...
        graph.addNode(new Location("IOT Lab", "IOT Lab (345,610)", 3));
        graph.addNode(new Location("Female WC-3", "Female WC-3 (205,710)", 3));
        graph.addNode(new Location("Stairs11", "Stairs11 (205,760)", 3));
        graph.addNode(new Location("HOD Office-2", "HOD Office-2 (345,710)", 3));
        graph.addNode(new Location("Basic Electronic Lab", "Basic Electronic Lab (425,760)", 3));
        graph.addNode(new Location("CR-402", "CR-402 (485,760)", 3));
        graph.addNode(new Location("Logic Design lab", "Logic Design lab (535,760)", 3));
        graph.addNode(new Location("Basic Electrical Lab", "Basic Electrical Lab (785,760)", 3));
        graph.addNode(new Location("CR-401", "CR-401 (885,760)", 3));
        graph.addNode(new Location("c10", "c10 (775,410)", 3));
        graph.addNode(new Location("Lab-4", "Lab-4 (775,610)", 3));
        graph.addNode(new Location("Faculty Room-3", "Faculty Room-3 (775,710)", 3));
        graph.addNode(new Location("Male WC-3", "Male WC-3 (915,710)", 3));
        graph.addNode(new Location("Stairs12", "Stairs12 (915,760)", 3));
